...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Thu Jan 26 16:35:34 2017
# Project:  Zilbercoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Zilbercoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Zilbercoin/src/leveldb/libleveldb.a /tmp/Zilbercoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Zilbercoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Zilbercoin-qt.pro
...
/tmp/Zilbercoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Zilbercoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Zilbercoin/build/build.h: FORCE
	cd /tmp/Zilbercoin; /bin/sh share/genbuild.sh /tmp/Zilbercoin/build/build.h
