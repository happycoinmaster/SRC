...
static const char *strMainNetDNSSeed[][2] = {
    {"zilbercoin.space", "znode1.zilbercoin.space"},
    {"zilbercoin.space", "znode2.zilbercoin.space"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zilbercoin is probably already running."), addrBind.ToString().c_str());
        else
